...
def add_suggest_event(conn, event_name, theme_id, type_id, participants, beginning_date, expiration_date, start_time,
    ...
    cur = conn.cursor()
    cur.execute(f'''
    INSERT INTO event(event_name,theme_id,type_id,participants,beginning_date,expiration_date,start_time,end_time,organizer_id,location_id,description,status_id,status, picture, mail) 
    VALUES (:event_name,:theme_id,:type_id,:participants,:beginning_date,:expiration_date,:start_time,:end_time,:organizer_id,:location_id,:description,:status_id,'suggest', :picture, :mail)
